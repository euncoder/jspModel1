...
<body>
	...
	<div class="center">
		...
		<form action="loginAf.jsp" method="post">
			...
			<table border="1">
				...
				<tr>
					<td colspan="2"><input type="submit" value="log-in"> <a
						href="regi.jsp">회원가입</a></td>
				</tr>
			</table>
	...
	<script type="text/javascript">
		...
		$("#chk_save_id").click(function() {
			...
			if ($("#chk_save_id").is(":checked") == true) { // 체크박스에 체크된 경우,

				if ($("#id").val().trim() == "") {
					alert('id를 입력해 주십시오'); //id에 빈문자로 남기고 체크하면 팝업창이 뜸
				...
				// cookie를 저장	           기한   모든경로
				$.removeCookie("user_id", {path : './'}); //(key,value) 
				}
		});
	</script>
